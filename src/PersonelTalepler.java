...
public class PersonelTalepler extends JFrame {
	...
	public void talepListele(String kutuphaneID){
		try {
			...
			while (rs.next()) {
			    String o[] = {rs.getString("kitap_talep_id".toString()), rs.getString("ogrenci_id"), 
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PersonelTalepler frame = new PersonelTalepler();
	...
	public PersonelTalepler() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(PersonelTalepler.class.getResource("/logo.png")));
		setTitle("Personel - Talepler");
		...
		scrollPaneKitap.setBounds(10, 232, 646, 151);
		...
		kitapTablo.setModel(new DefaultTableModel(
			...
			new String[] {
				"Kitap ID", "Kitap Ad\u0131", "Kitap Yazar\u0131", "Yay\u0131mc\u0131s\u0131", "Kitap Adedi"
			}
		));
		...
		jtxtKitapFiltre.setBounds(10, 203, 646, 19);
		...
		btnEkle.setBounds(73, 141, 137, 21);
		panel.add(btnEkle);
		...
		btnSil.setBounds(73, 172, 137, 21);
		panel.add(btnSil);
		
		JScrollPane scrollPaneTalep = new JScrollPane();
		scrollPaneTalep.setBounds(230, 36, 426, 157);
		...
		talepTablo.setModel(new DefaultTableModel(
			...
			new String[] {
				"Talep ID", "Ogrenci ID", "Kitap Ad\u0131", "Kitap Yazar\u0131", "Kitap Yay\u0131mc\u0131s\u0131"
			}
		));
		...
		jtxtTalepFiltre.setBounds(230, 10, 426, 19);
		...
		jtxtGizliKutID.setBounds(10, 174, 7, 19);
